...
public class PacManFurtherThan40 implements Transition  {

	public static double thresold = 40;  /// Lo que cambia entre clases
	
	GHOST ghost;
	public PacManFurtherThan40(GHOST ghost) {
		super();
		this.ghost = ghost;
	}
